...
{
    // 系统更新管理器dbus服务
    m_managerInvokerInter = InvokerFactory::GetInstance().CreateInvoker("com.deepin.lastore",
                                                                        "/com/deepin/lastore",
                                                                        "com.deepin.lastore.Manager",
                                                                        ConnectType::SYSTEM, this);
    // 系统更新dbus服务
    m_updaterInvokerInter = InvokerFactory::GetInstance().CreateInvoker("com.deepin.lastore",
                                                                        "/com/deepin/lastore",
...
{
    m_checkUpdateJobInvokerInter = InvokerFactory::GetInstance().CreateInvoker("com.deepin.lastore",
                                                                               jobPath,
